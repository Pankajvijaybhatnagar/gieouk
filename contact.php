                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="contact-three__single">
                            ...
                            <p class="contact-three__text">6391 Elgin St. Celina, Delaware 10299</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="contact-three__single">
                            ...
                            <h3 class="contact-three__title">Phone Number</h3>
                            <p class="contact-three__text"><a href="tel:6295550129">(629) 555-0129</a></p>
                        </div>
                    </div>
                    <!--Contact Three Single End-->
                    <!--Contact Three Single Start-->
