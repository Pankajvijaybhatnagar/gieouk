                ...
                <p>An evening of insight, inspiration, and cultural richness — not to be missed</p>
                    ...
                    <div class="service-details__content-two" style="font-family: inherit;">
                        <h4 class="service-details__title-two" style="color: #4e151b;">
                            <i class="fas fa-flag" style="color: #4e151b; margin-right: 6px;"></i> Manchester Gita
                            Festival 2025 – Shobha Yatra
                        </h4>
                        <p class="service-details__text-3" style="text-align: justify;">
                            <strong><i class="fas fa-hand-holding-heart" style="color: #4e151b; margin-right: 6px;"></i>
                                Procession for Peace, Love & Harmony</strong><br><br>
                        ...
                        <p class="service-details__text-3" style="text-align: justify;">
                            Join us for the spiritually uplifting Shobha Yatra — a procession for peace, love, and
                            harmony, bringing together hearts, families, and communities in joyful celebration.
                            <br><br>
                            This sacred walk symbolises the journey from personal yogic practice to collective devotion,
                            echoing the timeless wisdom of the Bhagwad Gita — that unity, service, and love are the true
                        ...
                        <h4 class="service-details__title-two" style="color: #4e151b;">
                            <i class="fas fa-dove" style="color: #4e151b; margin-right: 6px;"></i> A Journey with
                            Purpose
                        </h4>
                        <p class="service-details__text-3" style="text-align: justify;">
                            The route takes us from the calm of Chorlton Park, along St Werburgh’s Road and Wilbraham
                            Road, to the vibrant spiritual home of Gita Bhavan Hindu Temple.
                            A gentle incline along the way adds to the symbolism of spiritual effort and
                            elevation.<br><br>
                            Join in with music, mantra chanting, dancing, and flags as we walk together in joy and
                            harmony.
                        </p>
                        ...
                        <h4 class="service-details__title-two" style="color: #4e151b;">
                            <i class="fas fa-shoe-prints" style="color: #4e151b; margin-right: 6px;"></i> Procession
                            Details
                        </h4>
                        <ul style="padding-left: 20px; text-align: justify; list-style-type: disc;">
                            <li><strong>Start Point:</strong> Chorlton Park (assemble near the Pavilion from 2:30 PM)
                            </li>
                            ...
                            <li><strong>End Point:</strong> Gita Bhavan Hindu Temple, 231 Withington Road, Manchester
                                M16 8HX</li>
                        ...
                        <h4 class="service-details__title-two" style="color: #4e151b;">
                            <i class="fas fa-shuttle-van" style="color: #4e151b; margin-right: 6px;"></i> Return Travel
                            Support
                        </h4>
                        <p class="service-details__text-3" style="text-align: justify;">
                            We are working to provide a shuttlebus service for drivers to return to Chorlton Park and
                            collect their vehicles after the procession.
                        ...
                        <p class="service-details__text-3" style="text-align: justify;">
                            <i class="fas fa-shoe-prints" style="color: #4e151b; margin-right: 6px;"></i> Wear
                            comfortable shoes and weather-appropriate clothing<br>
                            <i class="fas fa-water" style="color: #4e151b; margin-right: 6px;"></i> Bring water and
                            sun/rain protection<br>
                            <i class="fas fa-dove" style="color: #4e151b; margin-right: 6px;"></i> Let’s walk together
                    ...
                    <div class="service-details__service-process">
                        <h4 class="service-details__service-process-title">
                            <i class="fas fa-praying-hands" style="color: #2c3e50; margin-right: 6px;"></i> Shobha Yatra
                            Highlights – A Journey of Unity & Devotion
                        </h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__service-process-single">
                                    ...
                                    <div class="service-details__service-process-content">
                                        <h4 class="service-details__service-process-content-title"><a href="#">Unity in
                                                Community</a></h4>
                                        <p class="service-details__service-process-content-text">
                                            Walk together in harmony — bringing together families, friends, and faith
                                            groups in one joyous spirit.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__service-process-single">
                                    ...
                                    <div class="service-details__service-process-content">
                                        <h4 class="service-details__service-process-content-title"><a href="#">Spirit of
                                                Devotion</a></h4>
                                        <p class="service-details__service-process-content-text">
                                            Chant, drum, and dance with joy as we express bhakti — heartfelt devotion
                                            through celebration.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="service-details__service-process-single">
                                    ...
                                    <div class="service-details__service-process-content">
                                        <h4 class="service-details__service-process-content-title"><a href="#">Symbolic
                                                Journey</a></h4>
                                        <p class="service-details__service-process-content-text">
                                            A sacred walk from the calm of Chorlton Park to the spiritual heart of Gita
                                            Bhavan — each step a reflection of inner elevation.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="service-details__service-process-single">
                                    <div class="service-details__service-process-icon">
                                        <i class="fas fa-hand-holding-heart"
                                            style="font-size: 24px; color: #2c3e50;"></i>
                                    </div>
                                    <div class="service-details__service-process-content">
                                        <h4 class="service-details__service-process-content-title"><a href="#">Seva &
                                                Togetherness</a></h4>
                                        <p class="service-details__service-process-content-text">
                                            Practice selfless service, carry flags, support others — every moment
                                            reflects unity, seva, and shared purpose.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="service-details__content-two" style="font-family: inherit;">
                                <h4 class="service-details__title-one" style="color: #4e151b;">
                                    <i class="fas fa-music" style="color: #4e151b; margin-right: 6px;"></i> Manchester
                                    Gita Festival 2025 – Bhakti Yoga Evening
                                </h4>
                                <p class="service-details__text-3" style="text-align: justify;">
                                    <strong><i class="fas fa-heart" style="color: #4e151b; margin-right: 6px;"></i> An
                                        Evening of Devotion through Music, Mantra & Meditation</strong><br><br>
                                    <i class="fas fa-calendar-alt" style="color: #4e151b; margin-right: 6px;"></i>
                                    <strong>Date:</strong> Saturday 21st June 2025<br>
                                    <i class="fas fa-clock" style="color: #4e151b; margin-right: 6px;"></i>
                                    <strong>Time:</strong> 4:00 PM – 7:00 PM<br>
                                    <i class="fas fa-map-marker-alt" style="color: #4e151b; margin-right: 6px;"></i>
                                    <strong>Venue:</strong> Gita Bhavan Hindu Temple, 231 Withington Road, Manchester
                                    M16 8HX
                                </p>

                                <p class="service-details__text-3" style="text-align: justify;">
                                    Conclude your day with an immersive Bhakti Yoga Evening — a heart-opening
                                    celebration of devotion through music, mantra, and meditation, held at the serene
                                    Gita Bhavan Hindu Temple.
                                    <br><br>
                                    This special event embodies the Path of Bhakti Yoga — devotion and surrender to the
                                    Divine through love, chanting, and heartfelt expression, as taught in the Bhagwad
                                    Gita.
                                </p>
                                ...
                                <h4 class="service-details__title-two" style="color: #4e151b;">
                                    <i class="fas fa-star" style="color: #4e151b; margin-right: 6px;"></i> Evening
                                    Highlights
                                </h4>
                                <ul style="padding-left: 20px; text-align: justify; list-style-type: disc;">
                                    <li>Soul-stirring kirtan (devotional singing) led by renowned local and visiting
                                        artists</li>
                                    ...
                                    <li>A spiritually uplifting atmosphere to connect deeply with yourself and the
                                        Divine</li>
                                </ul>
                                ...
                                <p class="service-details__text-3" style="text-align: justify;">
                                    After the programme, Prasad (sanctified vegetarian food) will be lovingly served to
                                    all guests — an opportunity to share food and fellowship in the spirit of Bhakti.
                                </p>
                                ...
                                <p class="service-details__text-3" style="text-align: justify;">
                                    On-site parking is available at the temple and on surrounding residential roads. We
                                    recommend arriving early to ensure easy access and a good seat for the programme.
                                </p>

                                <hr style="border-top: 1px solid #ccc;">

                                <p class="service-details__text-3" style="text-align: justify;">
                                    <i class="fas fa-tshirt" style="color: #4e151b; margin-right: 6px;"></i>
                                    <strong>Dress Code:</strong> Traditional/Cultural attire encouraged<br>
                                    <i class="fas fa-microphone-alt" style="color: #4e151b; margin-right: 6px;"></i>
                                    Bring your voice, your heart, and your presence<br>
                                    <i class="fas fa-dove" style="color: #4e151b; margin-right: 6px;"></i> Open to all –
                                    come as you are
                                </p>
                            </div>
                        ...
                        <ul class="list-unstyled service-details__brochure-list">
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <p>All the details for participants including the route map, meeting points, and
                                        travel tips.</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <p>Discover the vision, values, and key themes of this year’s Manchester Gita
                                        Festival.</p>
                                </div>
                            </li>
                        </ul>
